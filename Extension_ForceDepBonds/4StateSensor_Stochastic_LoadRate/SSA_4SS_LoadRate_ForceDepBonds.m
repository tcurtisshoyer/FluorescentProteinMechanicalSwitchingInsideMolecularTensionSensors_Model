...
LoadingRate = ModelParams.LoadingRate;
...
%% Initial Conditions
AllSensors_ActualForce = zeros(numSensors,1);
...
while t<tend
    ...
    % ***** [1D] Update Force according to Linear Loading Rate *****
    AllSensors_ActualForce = AllSensors_ActualForce + LoadingRate*dt; 

    % [1E] Optional: Log Linkage Transition 
    ...
    if thisStateVariableID==0 % Turnover Transition (D#A#-->D1A1)
        ...
        AllSensors_ActualForce(thisSensorID) = 0;
    end
