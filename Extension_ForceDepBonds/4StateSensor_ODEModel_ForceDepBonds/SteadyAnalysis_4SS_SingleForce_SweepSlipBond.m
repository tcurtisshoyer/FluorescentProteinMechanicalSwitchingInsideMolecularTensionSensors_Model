...
StudyName = 'SweepSlipBond';
PlotOutDir = StudyName;
mkdir(PlotOutDir);

% What? 9 Diff Slip Bonds with Different Fb values
...
for Fb = [Inf 1 3 5 8 25] % Coefficent [pN] in Bell Model
    ...
    BondModels{id_BondModel} = SlipBond_TwoPathBellModelParams;
...
%% [1] Acceptor Only: 9 Diff Catch-Slip Bonds with Different Fb values
...
for SimulationSetID=SimulationSetID_toPlot
    ...
    legend_text = [legend_text, ['Fb = ' num2str(round(kT/xb1,2))]];
