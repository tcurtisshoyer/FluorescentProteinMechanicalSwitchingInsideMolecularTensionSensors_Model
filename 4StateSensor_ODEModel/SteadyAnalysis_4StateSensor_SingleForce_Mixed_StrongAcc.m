...
m_sweep = [1.5 1 1 1];
SweepPropsFPs.F_half_D = [5 F_half_sweep 5 5 5];
SweepPropsFPs.m_D = [1.5 m_sweep 1.5 1.5 1.5];
SweepPropsFPs.kms0_D = [0 1 1 1 1 .1 .316 1];
SweepPropsFPs.dxms_D = [.23 .23 .23 .23 .23 .23 .23 .23];

% Mech Switch Rate Constant for Acceptor
% kmsA = kms(F,F_half_A,m_A,kms0_A,dxms_A);
SweepPropsFPs.F_half_A = [5]*ones(1,8);
SweepPropsFPs.m_A = [1.5]*ones(1,8);
SweepPropsFPs.kms0_A = [1]*ones(1,8);
SweepPropsFPs.dxms_A = [.23]*ones(1,8);
...
FigName = 'ES_StrongAcc_SweepFhalfD';
Resolution_png = 300;
...
% Save full figure panel in specified file formats
FigName = 'RateConstants_StrongAcc_SweepFhalfD';
Resolution_png = 300;
print(f,fullfile(PlotOutDir,[FigName '.png']),'-dpng',['-r' num2str(Resolution_png)],'-painters');
print(f,fullfile(PlotOutDir,[FigName '.svg']),'-dsvg','-painters');
...
% Save full figure panel in specified file formats
FigName = 'ES_StrongAcc_Sweepkms0D';
Resolution_png = 300;
print(f,fullfile(PlotOutDir,[FigName '.png']),'-dpng',['-r' num2str(Resolution_png)],'-painters');
print(f,fullfile(PlotOutDir,[FigName '.svg']),'-dsvg','-painters');
...
% Save full figure panel in specified file formats
FigName = 'RateConstants_StrongAcc_Sweepkms0D';
Resolution_png = 300;
print(f,fullfile(PlotOutDir,[FigName '.png']),'-dpng',['-r' num2str(Resolution_png)],'-painters');
print(f,fullfile(PlotOutDir,[FigName '.svg']),'-dsvg','-painters');
